...
public class GestureBuilderActivity extends ListActivity {
    ...
    private static File sStoreFile;
    ...
    public static GestureLibrary readLibrary(Context context){
    	
    	//create file store on SDcard
    	if(sStoreFile == null) sStoreFile = new File(context.getExternalFilesDir(null), "MythMoteGestures");
        
    	//check if file does not exist
    	if(!sStoreFile.exists()){
    		try{
    			//create file
    			if(!sStoreFile.createNewFile()) throw new IOException("File.createNewFile() returned false.");
    		
    			//create input stream from resource
    			InputStream fin = context.getResources().openRawResource(R.raw.default_gestures);
    			
    			//create output stream from new file
    			FileOutputStream fout = new FileOutputStream(sStoreFile);
    			
    			//copy byte for byte resource to file
    			int b=-1;
    			while((b = fin.read()) != -1){
    				fout.write(b);
    			}
    			...
    			Log.d(MythMote.LOG_TAG, ex.getMessage());
    		} catch(SecurityException ex){
    			Log.d(MythMote.LOG_TAG, ex.getMessage());
    		}
    	}
    	
    	//create gesturelibrary
        if (sStore == null) {
    ...
    private void checkForEmpty() {
        if (mAdapter.getCount() == 0) {
            mEmpty.setText(R.string.gestures_empty_str);
        }
    }
...
out:        for (String name : entries) {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        menu.add(0, MENU_ID_RENAME, 0, R.string.gestures_rename_str);
        menu.add(0, MENU_ID_REMOVE, 0, R.string.gestures_delete_str);
    }
    ...
    private Dialog createRenameDialog() {
        ...
        ((TextView) layout.findViewById(R.id.label)).setText(R.string.gestures_rename_label_str);

        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setIcon(0);
        builder.setTitle(getString(R.string.gestures_rename_title_str));
        ...
        builder.setNegativeButton(getString(R.string.cancel_action_str),
        ...
        builder.setPositiveButton(getString(R.string.rename_action_str),
            new Dialog.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    changeGestureName();
                }
    ...
    private void deleteGesture(NamedGesture gesture) {
        ...
        Toast.makeText(this, R.string.gestures_delete_success_str, Toast.LENGTH_SHORT).show();
    }
    ...
    private class GesturesLoadTask extends AsyncTask<Void, NamedGesture, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == STATUS_NO_STORAGE) {
                ...
                mEmpty.setText(getString(R.string.gestures_error_loading_str,
